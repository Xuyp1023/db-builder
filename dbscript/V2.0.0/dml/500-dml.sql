...
delete from t_rule_validator where C_VALID_NAME in ('acc-lawOtherIdentType','acc-operOtherIdenttype');
INSERT INTO `t_rule_validator` (`C_SYS`, `C_VALID_NAME`, `C_SHOW_NAME`, `C_NAME`, `C_MUSTITEM`, `C_DATA_TYPE`, `N_DATA_LEN`, `N_DATA_SCALE`, `F_MAX`, `D_REGDATE`, `C_DESCRIPTION`) VALUES ('SCF', 'acc-lawOtherIdentType', '法人其他证件类型', 'lawOtherIdentType', '0', 'C', 20, 0, 20, '20160718', '法人证件类型');
INSERT INTO `t_rule_validator` (`C_SYS`, `C_VALID_NAME`, `C_SHOW_NAME`, `C_NAME`, `C_MUSTITEM`, `C_DATA_TYPE`, `N_DATA_LEN`, `N_DATA_SCALE`, `F_MAX`, `F_MIN`, `D_REGDATE`, `C_DESCRIPTION`) VALUES ('SCF', 'acc-operOtherIdenttype', '经办人其他证件类型', 'operOtherIdenttype', '0', 'C', 20, 0, 20, 0, '20160718', '经办人证件类型');
delete from t_rule_busin_validator where id in(10205,10204,10206,10207,10208,10209);
INSERT INTO `t_rule_busin_validator` (`ID`, `C_BUSIN_NAME`, `C_VALID_NAME`, `N_PRIORITY`, `C_STATUS`) VALUES (10205, 'saveOpenAccountInfo', 'acc-operOtherIdenttype', 27, '1');
INSERT INTO `t_rule_busin_validator` (`ID`, `C_BUSIN_NAME`, `C_VALID_NAME`, `N_PRIORITY`, `C_STATUS`) VALUES (10204, 'saveOpenAccountInfo', 'acc-lawOtherIdentType', 26, '1');
INSERT INTO `t_rule_busin_validator` (`ID`, `C_BUSIN_NAME`, `C_VALID_NAME`, `N_PRIORITY`, `C_STATUS`) VALUES (10206, 'saveOpenAccountInfoInstead', 'acc-operOtherIdenttype', 27, '1');
INSERT INTO `t_rule_busin_validator` (`ID`, `C_BUSIN_NAME`, `C_VALID_NAME`, `N_PRIORITY`, `C_STATUS`) VALUES (10207, 'saveOpenAccountInfoInstead', 'acc-lawOtherIdentType', 26, '1');
INSERT INTO `t_rule_busin_validator` (`ID`, `C_BUSIN_NAME`, `C_VALID_NAME`, `N_PRIORITY`, `C_STATUS`) VALUES (10208, 'saveOpenAccountApply', 'acc-operOtherIdenttype', 29, '1');
INSERT INTO `t_rule_busin_validator` (`ID`, `C_BUSIN_NAME`, `C_VALID_NAME`, `N_PRIORITY`, `C_STATUS`) VALUES (10209, 'saveOpenAccountApply', 'acc-lawOtherIdentType', 30, '1');
##代码优化   提交日期 2016/12/7
