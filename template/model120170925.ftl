...
<body>
  	<div class="container margin-auto">
		...
		<h3>第一条 应收账款</h3> 
	    <p class="line text-indent">
	      就双方签订的编号<span>${request.asset.basedataMap.receivableList[0].agreeNo}</span>的合同项下, 产生的应收账款￥<span>${request.balance} </span> 元，人民币大写：<span>${balanceCN!''} </span>，对应的《发票清单》，原付款时间为<span>
